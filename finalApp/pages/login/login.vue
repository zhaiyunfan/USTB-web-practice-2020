<template>
	<view class="login">
		<view class="content">
			...
			<!-- 主体表单 -->
			<view class="main">
				<wInput v-model="identify" type="text" maxlength="11" placeholder="用户名/电话/电子邮箱"></wInput>
	...
	export default {
		data() {
			return {
				...
				identify: uni.getStorageSync("user") == null ? "" : uni.getStorageSync("user").phoneNum, //用户/电话/email
				password: '', //密码
