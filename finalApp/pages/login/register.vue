<template>
	<view class="register">
		...
		<view class="content">
			...
			<!-- 主体 -->
			<view class="main">
				<wInput v-model="user.phoneNum" type="text" maxlength="11" placeholder="手机号"></wInput>
				<wInput v-model="user.password" type="password" maxlength="11" placeholder="密码" isShowPass></wInput>
