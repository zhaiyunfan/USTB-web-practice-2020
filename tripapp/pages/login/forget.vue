	...
	<view class="forget">
		...
		<view class="content">
			...
			<view class="main">
				...
				<wInput v-model="repPass" type="password" maxlength="11" placeholder="再次输入新密码" isShowPass></wInput>
				<wInput v-model="verCode" type="number" maxlength="4" placeholder="验证码" isShowCode codeText="获取验证码" setTime="30"
				...
				uni.request({
					...
					success: (res) => {
						...
						if (res.data.code == 200) {
							...
							// 更新缓存
							this.user.password = getApp().globalData.user.password = res.data.data.password;
							console.log(this.user);
